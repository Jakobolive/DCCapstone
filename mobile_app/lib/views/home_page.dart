...
//         backgroundColor: Colors.teal,
//         actions: [
//           if (userProvider.renterProfiles.isNotEmpty || userProvider.landlordProfiles.isNotEmpty)
//             Padding(
//               padding: const EdgeInsets.symmetric(horizontal: 10),
//               child: DropdownButton<Map<String, dynamic>>(
//                 value: userProvider.selectedProfile,
...
//                 onChanged: (Map<String, dynamic>? newValue) {
//                   if (newValue != null) {
//                     final isRenter = userProvider.renterProfiles.contains(newValue);
//                     userProvider.setSelectedProfile(newValue, isRenter ? "Renter" : "Landlord");
//                   }
//                 },
//                 items: [
//                   ...userProvider.renterProfiles.map((profile) {
//                     return DropdownMenuItem<Map<String, dynamic>>(
//                       value: profile,
//                       child: Text(profile['preferred_name'] ?? "Renter Profile"),
//                     );
//                   }),
//                   ...userProvider.landlordProfiles.map((profile) {
//                     return DropdownMenuItem<Map<String, dynamic>>(
//                       value: profile,
//                       child: Text(profile['street_address'] ?? "Landlord Profile"),
//                     );
//                   }),
//                 ],
//               ),
...
//         ],
//       ),
//       body: userProvider.listings.isEmpty
...
//                         child: Image.network(
//                           userProvider.listings[index]['image']!,
//                           fit: BoxFit.cover,
//                         ),
//                       ),
//                     ),
...
//                         children: [
//                           Text(
//                             userProvider.listings[index]['title']!,
//                             style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
//                           ),
//                           Text(
//                             userProvider.listings[index]['price']!,
...
//               );
//             },
//             itemCount: userProvider.listings.length,
//             itemWidth: MediaQuery.of(context).size.width * 0.85,
//             itemHeight: MediaQuery.of(context).size.height * 0.6,
//             layout: SwiperLayout.DEFAULT,
//           ),
...
class SwipePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: userProvider.listings?.isEmpty ?? true
          ? const Center(
              child: CircularProgressIndicator()) // Show loader while fetching
          : Swiper(
              itemBuilder: (BuildContext context, int index) {
                final listing = userProvider.listings![index];
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              listing['street_address'] ?? "No title",
                              style: const TextStyle(
                                  fontSize: 20, fontWeight: FontWeight.bold),
                            ),
                            Text(
                              listing['asking_price'].toString() ?? "No price",
                              style: const TextStyle(
              ...
              itemCount: userProvider.listings?.length ?? 0,
              itemWidth: MediaQuery.of(context).size.width * 0.85,
              itemHeight: MediaQuery.of(context).size.height * 0.6,
              layout: SwiperLayout.DEFAULT,
              onIndexChanged: (index) {
